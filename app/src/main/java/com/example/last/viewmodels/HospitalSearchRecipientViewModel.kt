...
class HospitalSearchRecipientViewModel : ViewModel() {
        ...
        database.addValueEventListener(object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                for (recipientSnapshot in snapshot.children) {
                    ...
                    val hospitalAffiliation = recipientSnapshot.child("hospitalAffiliation").getValue(String::class.java) ?: ""
            ...
            override fun onCancelled(error: DatabaseError) {
                this@HospitalSearchRecipientViewModel.error = error.message
                isLoading = false
            }
        })
    }
